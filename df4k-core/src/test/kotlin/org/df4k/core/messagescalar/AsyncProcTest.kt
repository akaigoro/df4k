...
import org.df4k.core.connector.messagescalar.*
import org.df4k.core.node.Action
import org.df4k.core.node.messagescalar.AsyncBiFunction
import org.df4k.core.node.messagescalar.AsyncSupplier
...
class AsyncProcTest {
    ...
    internal class Plus() : AsyncBiFunction<Double, Double, Double>({ val1: Double, val2: Double -> val1 + val2 }) {
        ...
        protected constructor(pa: ScalarPublisher<*>, pb: ScalarPublisher<*>) : this() {
            pa.subscribe(param1)
            pb.subscribe(param2)
        }
    }
    ...
    internal open class Mult() : AsyncBiFunction<Double, Double, Double>({ val1: Double, val2: Double -> val1 * val2 }) {
        ...
        constructor(pa: ScalarPublisher<*>, pb: ScalarPublisher<*>) : this() {
            pa.subscribe(param1)
            pb.subscribe(param2)
        }
    }
