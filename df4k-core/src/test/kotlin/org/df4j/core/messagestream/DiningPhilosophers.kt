...
class DiningPhilosophers {
    ...
    fun test() {
        val forkPlaces:Array<ForkPlace> = Array<ForkPlace>(num,
        ...
        val philosophers = Array<Philosopher>(num,
                // create philosophers
                {k:Int->
                Philosopher(k, forkPlaces, counter)
                })
    ...
    internal class Philosopher(var id: Int, forkPlaces: Array<ForkPlace>, var counter: CountDownLatch) {
        ...
        private inner class DelayedAsyncProc constructor(internal val next: AsyncProcedure<*>) : AsyncProcedure<Void>() {
